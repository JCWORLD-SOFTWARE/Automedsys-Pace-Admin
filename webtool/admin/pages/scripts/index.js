        ...
        initDashboardDaterange: function () {
            ...
            $('#dashboard-report-range').daterangepicker(
            {
                    ...
                    ranges: {
                        ...
                        'Next 30 Days': [moment(), moment().add('days',20)],
            ...
            function(start, end, label) {
                    ...
                    $.ajax({
                        dataType: "json",
                        url: 'schedule.php',
                        data: 'start='+start.format('YYYY-MM-DD')+'&end='+end.format('YYYY-MM-DD')+'&_='+Math.floor(Date.now() / 1000),
            ...
            $('#dashboard2-report-range').daterangepicker({
                    opens: (Metronic.isRTL() ? 'right' : 'left'),
...
*/
            ...
            $('#dashboard-report-range span').html(moment().format('MMMM D, YYYY') + ' - ' + moment().add('days', 29).format('MMMM D, YYYY'));
