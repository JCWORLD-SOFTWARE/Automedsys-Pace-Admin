...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>AutoMedSys Practice Manager</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta content="" name="description"/>
        <meta content="" name="author"/>
        <meta http-equiv="refresh" content="1200;url=<?php echo base_url(); ?>practiceuser/logout">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner">
                ...
                <div class="page-logo" style='style="margin: 0px 0 0 0;"'>
                    <a href="index.html">
                        <img src="../../webtool/img/automedsys.png" alt="AutoMedSys" style="width:75%;" class="logo-default"/>
                    </a>
                    <div class="menu-toggler sidebar-toggler hide">
                      ...
                      <ul class="nav navbar-nav"  style='background-color: #ffffff;'>
                           <li>
                               <h4><?php echo  $_SESSION["practice_info"]["OrganizationName"]; ?></h4>
                                </li>
                    </ul>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="AutoMedSys" class="img-circle" src="../../webtool/admin/layout/img/avatar3_small.jpg"/>
                                <span class="username username-hide-on-mobile">
                                   <?php echo  $_SESSION["user_info"]["FirstName"]; ?>[<?= $_SESSION["authToken"]["Username"] ?>] </span>
