...
<div class="form-group">
        ...
        <input type="text" name="firstname" placeholder="John" value="<?=$firstname?>" class="form-control"/>
</div>
<div class="form-group">
        <label class="control-label">Lastname</label>
        <input type="text" name="lastname" placeholder="Doe" value="<?=$lastname?>" class="form-control"/>
</div>
<div class="form-group">
...
<div class="form-group">
        ...
        <input type="text" name="completed" placeholder="<?=date('Y-m-d H:i:s')?>" value="<?=$completed?>" class="form-control"/>
</div>
<div class="form-group">
    ...
    <a class="edit" href="<?php echo base_url(); ?>crud/practiceregistration" onclick="return confirm('Are you sure you want to cancel?');">
