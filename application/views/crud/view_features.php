        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase">Feature Management</span>
                </div>
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                            <a class="edit" href="<?php echo base_url(); ?>crud/featurecreate">
                        ...
                        <?php foreach ($res as $item) : ?>
                            ...
                            <tr>
                                ...
                                <td style="width:100px;">
                                    <a class="edit" href="<?php echo base_url(); ?>crud/featureupdate?id=<?= $item["id"] ?>">
                                        <button id="sample_editable_1_new" class="btn green">Edit</button></a>
                                </td>
                                <td style="width:100px;">
                                    <a class="edit" href="<?php echo base_url(); ?>crud/featuredelete?id=<?= $item["id"] ?>">
                                        <button id="sample_editable_1_new" class="btn red" onclick="return confirm('Are you sure you want to delete this feature?');">Delete</button> </a>
                                </td>
                            </tr>
