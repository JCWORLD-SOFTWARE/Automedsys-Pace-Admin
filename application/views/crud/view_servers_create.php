        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase">Servers Management</span>
                </div>
...
<div class="form-group">
        ...
        <input type="text" name="name" placeholder="John Doe Server" value="<?=$name?>" class="form-control"/>
</div>
<div class="form-group">
        <label class="control-label">Server</label>
        <input type="text" name="server" placeholder="hostname.tld" value="<?=$server?>" class="form-control"/>
</div>
<div class="form-group">
        <label class="control-label">Port</label>
        <input type="text" name="port" placeholder="12345" value="<?=$port?>" class="form-control"/>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <a class="edit" href="<?php echo base_url(); ?>crud/servers" onclick="return confirm('Are you sure you want to cancel?');">
