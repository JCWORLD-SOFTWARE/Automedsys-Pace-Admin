...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            Practice Registration Management
        </li>
    </ul>
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase">Practice Registration Management</span>
                </div>
            ...
            <div class="portlet-body overflow-x-scroll">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                            <a class="edit" href="<?php echo base_url(); ?>crud/practiceregistrationcreate?session=<?= $_SESSION["session"]?>">
                                <button id="sample_editable_1_new" class="btn green">
                                    Add Practice Registration <i class="fa fa-plus"></i>
                                </button>
                                </a>
                            </div>
                        </div>
                    ...
                    <tbody>
                        <?php foreach ($res as $item) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?= $item["username"] ?> (<?= $item["online_username"] ?>)
                                </td>
                                <td >
                                    <?= $item["practice_code"] ?>
                                </td>
                                ...
                                <td class="center">
                                    <?= strtok($item["completed"],'.') ?>
                                </td>
                                <td class="center">
                                    <?= $item["loc"] ?>
                                </td>
                                <td style="width:100px;">
                                    <a class="edit" href="<?php echo base_url(); ?>crud/practiceregistrationupdate?id=<?= $item["id"] ?>">
                                        <button id="sample_editable_1_new" class="btn green">Edit</button></a>
                                </td>
                                <td style="width:100px;">
                                    <a class="edit" href="<?php echo base_url(); ?>crud/practiceregistrationdelete?id=<?= $item["id"] ?>">
                                        <button id="sample_editable_1_new" class="btn red" onclick="return confirm('Are you sure you want to delete this practice registrtion?');">Delete</button> </a>
                                </td>
                            </tr>
