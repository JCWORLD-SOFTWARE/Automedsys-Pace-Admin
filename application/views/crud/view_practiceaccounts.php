            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                            <a class="edit" href="<?php echo base_url(); ?>crud/practiceaccountcreate">
                                <button id="sample_editable_1_new" class="btn green">
                                    Add Practice Account <i class="fa fa-plus"></i>
                                </button>
                                </a>
                            </div>
                        </div>
                        ...
                        <?php foreach ($res as $item) : ?>
                            ...
                            <tr>
                                ...
                                <td style="width:100px;">
                                    <a class="edit" href="<?php echo base_url(); ?>crud/practiceaccountupdate?id=<?= $item["id"] ?>">
                                        <button id="sample_editable_1_new" class="btn green">Edit</button></a>
                                </td>
                                <td style="width:100px;">
                                    <a class="edit" href="<?php echo base_url(); ?>crud/practiceaccountdelete?id=<?= $item["id"] ?>">
                                        <button id="sample_editable_1_new" class="btn red" onclick="return confirm('Are you sure you want to delete this practice account?');">Delete</button> </a>
                                </td>
                            </tr>
